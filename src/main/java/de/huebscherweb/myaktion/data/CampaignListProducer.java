...
import static de.huebscherweb.myaktion.model.Donation.Status.IN_PROCESS;
import static de.huebscherweb.myaktion.model.Donation.Status.TRANSFERRED;
...
import de.huebscherweb.myaktion.model.Account;
...
public class CampaignListProducer implements Serializable {
	...
	private static final long serialVersionUID = -1221582532972877820L;
	...
	public List<Campaign> createMockCampaigns() {
		...
		donation1.setStatus(TRANSFERRED);
		...
		donation2.setStatus(IN_PROCESS);
		...
		campaign2.setAmountDonatedSoFar(2742d);
